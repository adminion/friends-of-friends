...
module.exports = function friendshipPlugin (schema, options) {
     ...
     * @see         [FriendshipModel.getRequests]{@link FrienshipModel.getRequests}
     */
     ...
     * @see         [FriendshipModel.getReceivedRequests]{@link FriendshipModel.getRecievedRequests}
     */
     ...
     * @param       {Function} done         - required callback, passed the populated friendship
     * @see         [AccountModel.getFriendship]{@link AccountModel.getFriendship}
     */
